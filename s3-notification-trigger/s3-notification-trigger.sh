...
# version: v1
# 
# purpose: triggers a notification when something is uploaded to s3 bucket.
##################################
...
bucket_name="Srujan-Nalam-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="srujan.nalam@gmail.com"
...
aws sns publish \
  --topic-arn "$topic_arn" \
  --subject "A new object created in your s3 bucket" \
  --message "Hello from Srujan Nalam, enjoy shell scripting and aws learnings !!!!!!"
